"""
Django settings for mycustomshop project.
...
SECRET_KEY = 'yk3o@2mlqzuuq&cuu835%6q(y748ntpraew))iieq)z1#05zzj'
...
MIDDLEWARE = [
    ...
    # 'django.middleware.locale.LocaleMiddleware'  # Required by Django CMS - if multilingual FIXME: Broken!!
    ...
    'cms.middleware.utils.ApphookReloadMiddleware'  # Required by Django CMS - Optional, TODO: Help Django Shop app hooks??
]

ROOT_URLCONF = 'mycustomshop.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': ['templates'],  # Required by Django CMS
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'mycustomshop.wsgi.application'
